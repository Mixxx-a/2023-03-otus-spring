...
CREATE TABLE IF NOT EXISTS ROLES(ID IDENTITY PRIMARY KEY,
                   NAME VARCHAR(255));

CREATE TABLE IF NOT EXISTS USERS_ROLES(ID IDENTITY PRIMARY KEY,
                   USERID BIGINT, FOREIGN KEY (USERID) REFERENCES USERS(ID),
                   ROLEID BIGINT, FOREIGN KEY (ROLEID) REFERENCES ROLES(ID));